 ...
 * @author miyanishi
 */
public final class RuleOfMoveFromHomeToCompany extends TAgentRule {
     ...
     */
    public RuleOfMoveFromHomeToCompany(String name, TRole owner) {
        // 親クラスのコンストラクタを呼び出す．
        super(name, owner);
    }
    ...
    public final void doIt(TTime currentTime, Enum<?> currentStage, TSpotManager spotManager,
        ...
        RoleOfFather role = (RoleOfFather) getOwnerRole();

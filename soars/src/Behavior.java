...
public class Behavior {
    ...
    public static final Map<String, IndustryType> INDUSTRY_NAME_TO_INDUSTRY_TYPE = new HashMap<>();
    public static final Map<IndustryType, String> INDUSTRY_TYPE_TO_INDUSTRY_NAME = new HashMap<>();
    ...
    static {
        ...
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.A_AGRICULTURE_FORESTRY,"A_農業，林業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.B_FISHERIES,"B_漁業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.C_MINING_QUARRYING_GRAVEL,"C_鉱業，採石業，砂利採取業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.D_CONSTRUCTION,"D_建設業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.E_MANUFACTURING,"E_製造業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.F_ELECTRICITY_GAS_WATER,"F_電気・ガス・熱供給・水道業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.G_INFORMATION_COMMUNICATION,"G_情報通信業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.H_TRANSPORTATION_POSTAL,"H_運輸業，郵便業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.I_WHOLESALE_RETAIL,"I_卸売業，小売業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.J_FINANCE_INSURANCE,"J_金融業，保険業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.K_REAL_ESTATE_RENTAL,"K_不動産業，物品賃貸業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.L_RESEARCH_TECHNICAL_SERVICES,"L_学術研究，専門・技術サービス業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.M_ACCOMMODATION_FOOD_SERVICES,"M_宿泊業，飲食サービス業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.N_PERSONAL_SERVICES_ENTERTAINMENT,"N_生活関連サービス業，娯楽業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.O_EDUCATION_SUPPORT,"O_教育，学習支援業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.P_MEDICAL_WELFARE,"P_医療，福祉");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.Q_COMPOUND_SERVICES,"Q_複合サービス事業");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.R_OTHER_SERVICES,"R_サービス業（他に分類されないもの）");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.S_GOVERNMENT,"S_公務（他に分類されるものを除く）");
        INDUSTRY_TYPE_TO_INDUSTRY_NAME.put(IndustryType.T_UNCLASSIFIABLE_INDUSTRY,"T_分類不能の産業");
        // 逆のマッピングも作成
        for (Map.Entry<IndustryType, String> entry : INDUSTRY_TYPE_TO_INDUSTRY_NAME.entrySet()) {
            INDUSTRY_NAME_TO_INDUSTRY_TYPE.put(entry.getValue(), entry.getKey());
        }

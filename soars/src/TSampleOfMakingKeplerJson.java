...
public class TSampleOfMakingKeplerJson {
    ...
    public static void main(String[] args) throws IOException {
        int seed = 10400;
        int noOfPeople = 100;
        String workDir = "C:\\Users\\tora2\\IdeaProjects\\cityScope\\logs"; //入力ファイルが格納されているディレクトリ．出力先にもなる．
        String fileNameHead = "seed_"+ seed + "_no_" + noOfPeople + "_";
        String personTripFile = workDir + File.separator + fileNameHead + fileNameHead + "person_trips.csv"; //各個人の移動データのファイル．入力ファイル．
        String routeFile = workDir + File.separator + fileNameHead + fileNameHead + "person_trips_routes.obj"; //経路データのファイル．入力ファイル．
        String outputFile = workDir + File.separator + fileNameHead + "trips.json"; //kepler.gl用のファイル．出力ファイル．
